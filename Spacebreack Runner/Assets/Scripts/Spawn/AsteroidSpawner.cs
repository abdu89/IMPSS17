...
public class AsteroidSpawner : MonoBehaviour {
	...
	void FixedUpdate () {
		...
		if (counter == counterMax) {
			...
			counter = 0;
			counterMax = Random.Range (10, 30);
			//Spawn cube here
			GameObject t = Instantiate (toSpawn, new Vector3 (Random.Range (45, 60), Random.Range (0, 10), Random.Range (66, 150)), Quaternion.identity);
			Destroy (t, 15f);
			Debug.Log (t);
